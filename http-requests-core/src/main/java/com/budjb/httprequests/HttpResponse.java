...
public abstract class HttpResponse implements Closeable {
     ...
     */
    protected HttpResponse(EntityConverterManager converterManager, HttpRequest request, int status, MultiValuedMap headers, HttpEntity entity) throws IOException {
